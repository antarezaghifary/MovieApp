...
class MovieSource(
...
) : PagingSource<Int, ResultsItem>(), KoinComponent {
    ...
    override fun loadInitial(
        ...
        repository.movie(1, with_genres).compose(composeSingle())
            .subscribe({
                if (it.isNotEmpty()) {
    ...
    override fun loadAfter(
        ...
        repository.movie(params.key, with_genres).compose(composeSingle())
            .subscribe({
